...
EOF
  ...
  enterShell = ''
    ...
    echo "To start database (MariaDB) and it's admin interface (phpMyAdmin):"
    echo "  devenv up"
    echo "Then MariaDB can be access via phpMyAdmin at"
    echo "  http://127.0.0.1:8000"
    echo ""
    #echo "To start App1: php -S 127.0.0.1:8001 -t apps/app1/public"
    echo "To start App1:"
    echo "  devenv processes start app1"
    echo "Then the App1 can be access at"
    echo "  http://127.0.0.1:8001'"
    echo ""
    #echo "To start App2: php -S 127.0.0.1:8002 -t apps/app2/public"
    echo "To start App2:"
    echo "  devenv processes start app2"
    echo "Then the App2 can be access at"
    echo "  http://127.0.0.1:8002"
    echo ""
    #echo "To start App3: php -S 127.0.0.1:8003 -t apps/app3/public"
    echo "To start App3:"
    echo "  devenv processes start app3"
    echo "Then the App3 can be access at"
    echo "  http://127.0.0.1:8003"
    echo ""
    echo "To check status of the processes:"
    echo "  devenv processes status mysql"
    echo "  devenv processes status phpmyadmin"
    echo "  devenv processes status app1"
    echo "  devenv processes status app2"
    echo "  devenv processes status app3"
    echo "======================================================="
  '';
